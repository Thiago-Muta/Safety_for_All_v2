...
user1 = User.create!(email: 'thiagomuta@hotmail.com', password: '123123', first_name: 'Thiago', last_name: 'Muta', cpf:'272.092.250-13', phone_number:'(13)76046-3270', role: true)
...
user3 = User.create!(email: 'tassohenrique@hotmail.com', password: '123123', first_name: 'Tasso', last_name: 'Rodrigues', cpf:'259.981.560-64', phone_number:'(74)57430-5081', role: true)
user4 = User.create!(email: 'allyssoncomin@hotmail.com', password: '123123', first_name: 'Allysson', last_name: 'Comin', cpf:'174.041.680-58', phone_number:'(57)80576-4198', role: true)
user5 = User.create!(email: 'anariccetti@hotmail.com', password: '123123', first_name: 'Ana', last_name: 'Riccetti', cpf:'136.307.170-04', phone_number:'(73)27399-4148', role: true)
user6 = User.create!(email: 'eduardobrandiao@hotmail.com', password: '123123', first_name: 'Eduardo', last_name: 'Brandiao', cpf:'807.737.150-70', phone_number:'(38 14167-9192', role: true)
user7 = User.create!(email: 'brunogabriel@hotmail.com', password: '123123', first_name: 'Bruno', last_name: 'Gabriel', cpf:'523.806.100-53', phone_number:'(12)20947-7198', role: true)
user8 = User.create!(email: 'edcolen@hotmail.com', password: '123123', first_name: 'Ed', last_name: 'Colen', cpf:'493.020.050-46', phone_number:'(81)62820-0453', role: true)
user9 = User.create!(email: 'emiliogirardi@hotmail.com', password: '123123', first_name: 'Emilio', last_name: 'Girardi', cpf:'493.020.050-46', phone_number:'(33)29699-9914', role: true)
user10 = User.create!(email: 'felipebrasche@hotmail.com', password: '123123', first_name: 'Felipe', last_name: 'von Brasche', cpf:'918.890.920-45', phone_number:'(42)81117-2824', role: true)
user11 = User.create!(email: 'giovannanunes@hotmail.com', password: '123123', first_name: 'Giovanna', last_name: 'Nunes', cpf:'504.362.710-79', phone_number:'(25)29798-1189', role: true)
user12 = User.create!(email: 'giovanniguadagnucci@hotmail.com', password: '123123', first_name: 'Giovanni', last_name: 'Guadagnucci', cpf:'049.462.660-70', phone_number:'(45)46559-2776', role: true)
user13 = User.create!(email: 'guilhermeteixeira@hotmail.com', password: '123123', first_name: 'Guilherme', last_name: 'Teixeira', cpf:'222.379.110-70', phone_number:'(60)32552-1601', role: true)
user14 = User.create!(email: 'henriquemedeiros@hotmail.com', password: '123123', first_name: 'Henrique', last_name: 'Medeiros', cpf:'829.102.630-02', phone_number:'(22)28949-0668', role: true)
user15 = User.create!(email: 'igorareco@hotmail.com', password: '123123', first_name: 'Igor', last_name: 'Areco', cpf:'658.870.880-79', phone_number:'(38)39996-5877', role: true)
user16 = User.create!(email: 'igordepolli@hotmail.com', password: '123123', first_name: 'Igor', last_name: 'Depolli', cpf:'279.314.110-05', phone_number:'(47)31823-0992', role: true)
user17 = User.create!(email: 'josecarlos@hotmail.com', password: '123123', first_name: 'Jose', last_name: 'Carlos', cpf:'258.124.160-87', phone_number:'(40)14828-0847', role: true)
user18 = User.create!(email: 'kuxixima@hotmail.com', password: '123123', first_name: 'Kuxixima', last_name: 'Almeida', cpf:'322.396.080-56', phone_number:'(16)74763-7747', role: true)
user19 = User.create!(email: 'pedromeyer@hotmail.com', password: '123123', first_name: 'Pedro', last_name: 'Meyer', cpf:'112.531.020-07', phone_number:'(56)70235-2251', role: true)
user20 = User.create!(email: 'lucascamargo@hotmail.com', password: '123123', first_name: 'Lucas', last_name: 'Camargo', cpf:'715.745.730-04', phone_number:'(59)56352-8276', role: true)
user21 = User.create!(email: 'marianamarinho@hotmail.com', password: '123123', first_name: 'Mariana', last_name: 'Marinho', cpf:'322.940.350-97', phone_number:'(25)34221-2168', role: true)
user22 = User.create!(email: 'matleroux@hotmail.com', password: '123123', first_name: 'Mathieu', last_name: 'Le Roux', cpf:'777.059.410-31', phone_number:'(72)30350-6241', role: true)
user23 = User.create!(email: 'milenecardoso@hotmail.com', password: '123123', first_name: 'Milene', last_name: 'Cardoso', cpf:'674.981.540-56', phone_number:'(56)51442-3982', role: true)
user24 = User.create!(email: 'milleneprado@hotmail.com', password: '123123', first_name: 'Millene', last_name: 'Prado', cpf:'494.146.310-20', phone_number:'(15)25321-4999', role: true)
user25 = User.create!(email: 'nathandebaz@hotmail.com', password: '123123', first_name: 'Nathan', last_name: 'Debaz', cpf:'181.869.840-46', phone_number:'(71)44243-6701', role: true)
user26 = User.create!(email: 'netoconcon@hotmail.com', password: '123123', first_name: 'Neto', last_name: 'Concon', cpf:'699.644.870-02', phone_number:'(74)56997-7287', role: true)
user27 = User.create!(email: 'nicolasenne@hotmail.com', password: '123123', first_name: 'Nicolas', last_name: 'Enne', cpf:'612.807.370-00', phone_number:'(22)40963-5011', role: true)
user28 = User.create!(email: 'patykihara@hotmail.com', password: '123123', first_name: 'Paty', last_name: 'Kihara', cpf:'483.999.710-14', phone_number:'(89)23136-2007', role: true)
user29 = User.create!(email: 'rafaelalonso@hotmail.com', password: '123123', first_name: 'Rafael', last_name: 'Alonso', cpf:'240.765.590-70', phone_number:'(51)49496-8735', role: true)
user30 = User.create!(email: 'rafaelchun@hotmail.com', password: '123123', first_name: 'Rafael', last_name: 'Chun', cpf:'282.329.220-95', phone_number:'(10)35156-7767', role: true)
user31 = User.create!(email: 'raphaelrodrigues@hotmail.com', password: '123123', first_name: 'Raphael', last_name: 'Cruz', cpf:'538.374.590-47', phone_number:'(19 38253-8546', role: true)
user32 = User.create!(email: 'ricardohasenack@hotmail.com', password: '123123', first_name: 'Ricardo', last_name: 'Hasenack', cpf:'650.886.800-40', phone_number:'(50)25379-4725', role: true)
user33 = User.create!(email: 'robertobarros@hotmail.com', password: '123123', first_name: 'Roberto', last_name: 'Barros', cpf:'079.495.920-28', phone_number:'(76)38486-1028', role: true)
user34 = User.create!(email: 'taiguaramaran@hotmail.com', password: '123123', first_name: 'Taiguara', last_name: 'Maran', cpf:'002.175.270-27', phone_number:'(42)16305-6295', role: true)
user35 = User.create!(email: 'thiagoyoussef@hotmail.com', password: '123123', first_name: 'Thiago', last_name: 'Youssef', cpf:'351.815.160-68', phone_number:'(36)21603-5671', role: true)
user36 = User.create!(email: 'victorbrandao@hotmail.com', password: '123123', first_name: 'Victor', last_name: 'Brandao', cpf:'398.147.050-80', phone_number:'(77)68166-1794', role: true)
user37 = User.create!(email: 'victormoreira@hotmail.com', password: '123123', first_name: 'Victor', last_name: 'Moreira', cpf:'292.171.730-10', phone_number:'(23)57635-2647', role: true)
user38 = User.create!(email: 'enejota@hotmail.com', password: '123123', first_name: 'Neymar', last_name: 'Junior', cpf:'458.412.140-04', phone_number:'(64)84312-0790', role: true)
user39 = User.create!(email: 'carlosaugusto@hotmail.com', password: '123123', first_name: 'Carlos', last_name: 'Augusto', cpf:'754.961.420-24', phone_number:'(19)37611-8924', role: true)
user40 = User.create!(email: 'leonardoferreira@hotmail.com', password: '123123', first_name: 'Leonardo', last_name: 'Ferreira', cpf:'143.382.730-11', phone_number:'(77)27933-6321', role: true)
user41 = User.create!(email: 'doidao7@hotmail.com', password: '123123', first_name: 'Fabio', last_name: 'Alves', cpf:'516.985.240-13', phone_number:'(33)68893-8043', role: true)
user42 = User.create!(email: 'thierry@hotmail.com', password: '123123', first_name: 'Thierry', last_name: 'Fernando', cpf:'982.845.790-30', phone_number:'(40)73422-1067', role: true)
user43 = User.create!(email: 'fabiomelo@hotmail.com', password: '123123', first_name: 'Fabio', last_name: 'Melo', cpf:'856.321.110-24', phone_number:'(81)85717-6444', role: true)
user44 = User.create!(email: 'silvioaugusto@hotmail.com', password: '123123', first_name: 'Silvio', last_name: 'Augusto', cpf:'298.532.620-61', phone_number:'(22)50201-3016', role: true)
user45 = User.create!(email: 'sergiotankian@hotmail.com', password: '123123', first_name: 'Sergio', last_name: 'Tankian', cpf:'597.851.150-03', phone_number:'(43)73975-7285', role: true)
user46 = User.create!(email: 'magicjohnson@hotmail.com', password: '123123', first_name: 'Earvin', last_name: 'Johnson', cpf:'807.562.220-01', phone_number:'(28)75034-3670', role: true)
user47 = User.create!(email: 'fernandomelo@hotmail.com', password: '123123', first_name: 'Fernando', last_name: 'Melo', cpf:'942.260.570-90', phone_number:'(23)44701-1962', role: true)
user48 = User.create!(email: 'caiocastro@hotmail.com', password: '123123', first_name: 'Caio', last_name: 'Castro', cpf:'530.918.210-13', phone_number:'(64)43708-3250', role: true)
user49 = User.create!(email: 'marinabarbosa@hotmail.com', password: '123123', first_name: 'Marina', last_name: 'Ruy Barbosa', cpf:'731.198.020-85', phone_number:'(87)61137-1050', role: true)
user50 = User.create!(email: 'brunamarquezine@hotmail.com', password: '123123', first_name: 'Bruna', last_name: 'Marquezine', cpf:'952.566.440-68', phone_number:'(21)48274-0506', role: true)
